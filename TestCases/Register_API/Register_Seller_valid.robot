...
RegisterNewSeller IDnumber not enter kyc 0
    ${TokenEscrow}=  GetToken Escrow
...
RegisterNewSeller IDnumber valid kyc 0
    ${TokenEscrow}=  GetToken Escrow
...
RegisterNewSeller typeID citizenID valid kyc 0
    ${TokenEscrow}=  GetToken Escrow
    ${Id}=  Generate Random String  14   [NUMBERS]
