...
TC_18 Selle_Details_API idNum More than 30
    ...
    ${idNum}=  Randome_IDNumber
    ${SellerId}=  Get_SellerId
    UpdateSellerDetails  ${TokenEscrow}  @{escrowCompId}  ${SellerId}  ${idNum}567  ${3}  ${0}  A01  Invalid access token
...
TC_18 Selle_Details_API Duplicate idNum
    ...
    ${SellerId}=  Get_SellerId
    UpdateSellerDetails  ${TokenEscrow}  @{escrowCompId}  ${SellerId}  ${IdNumber1}  ${3}  ${0}  A01  Invalid access token
